class DamageSamplesController < ApplicationController
  ...
  private
    ...
    def element_params
      params.permit(:tag, :process_order, :product_type_id, :drying_method_id, :previous_usda, :ex_tag, :lot) # Quitar process_order
    end

    def edit_element_params
      params.permit(:process_order, :product_type_id, :drying_method_id, :previous_usda, :ex_tag, :lot) # Quitar process_order
    end
