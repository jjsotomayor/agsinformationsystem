...
class IpAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post ip_addresses_url, params: { ip_address: { comment: @ip_address.comment, ip: @ip_address.ip } }
  #   end
  #
  ...
  #   patch ip_address_url(@ip_address), params: { ip_address: { comment: @ip_address.comment, ip: @ip_address.ip } }
